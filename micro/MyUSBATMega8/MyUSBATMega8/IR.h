...
#define USECPERTICK 27  //27  // microseconds per clock interrupt tick
...
#define MAXBUF          250
#define STARTMIN        (unsigned int)(STARTMINN/USECPERTICK)
#define STARTMAX        (unsigned int)(STARTMAXN/USECPERTICK)
#define SPACEMIN        (unsigned int)(SPACEMINN/USECPERTICK)
#define SPACEMAX        (unsigned int)(SPACEMAXN/USECPERTICK)
#define BITMARKMIN      (unsigned int)(BITMARKMINN/USECPERTICK)
#define BITMARKMAX      (unsigned int)(BITMARKMAXN/USECPERTICK)
#define BITSPACEMIN     (unsigned int)(BITSPACEMINN/USECPERTICK)
#define BITSPACEMAX     (unsigned int)(BITSPACEMAXN/USECPERTICK)
//#define RPSPACEMIN      (unsigned long int)(RPSPACEMINN/USECPERTICK)
//#define RPSPACEMAX      (unsigned long int)(RPSPACEMAXN/USECPERTICK)
#define TOTALWAIT       (unsigned int)(TOTALWAITN/USECPERTICK)
